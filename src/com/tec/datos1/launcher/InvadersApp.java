    ...
    private void addJuegoObjeto(JuegoObjeto object, double x, double y) {
        ...
        private void onUpdate () throws InterruptedException {
            ...
            if (horda instanceof ClaseB || horda instanceof ClaseA || horda instanceof ClaseD) {
                ...
                int eliminados = horda.getCantidadEliminada();
                if (eliminados > 0) {
                    jugador.getEstadisticas().setPuntaje(jugador.getEstadisticas().getPuntaje() + eliminados);
                    horda.setCantidadEliminada(0);
                    eliminados = 0;
        ...
        public void resetJuego () {
            ...
            ventana.getChildren().remove(jugador);
